...
import com.djo.robodjo.recognizer.DataFiles;
import com.djo.robodjo.recognizer.Grammar;
import com.djo.robodjo.recognizer.PhonMapper;
...
public class Recognizer extends Activity implements RecognitionListener, SensorEventListener {

    private static final String TAG = "Recognizer";

    private static final String COMMAND_SEARCH = "поиск";
    private static final String KWS_SEARCH = "слушай";
    ...
    /*private void setupController() {
        new AsyncTask<Void, Void, Controller>() {
            ...
            protected void onPostExecute(Controller controller) {
                ...
                if (controller == null) {
                    Toast.makeText(getApplicationContext(), "Controller is not found", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(getApplicationContext(), "Controller is found! Please wait...", Toast.LENGTH_SHORT).show();
                    setupRecognizer();
                }
            }
        }.execute();
            ...
            protected Exception doInBackground(Void... params) {
                try {
                    ...
                    */
                    ...
                    BufferedReader bis = new BufferedReader(new InputStreamReader(getAssets().open("dict/ru/dic")));
                    String line;
                    ...
                    names = (String[]) strs.toArray(new String[strs.size()]);
